...
<head>
    ...
    <!-- Primary Meta Tag -->
    <title>Dashboard Affiliate - EcoMarket</title>
    <meta name="title" content="Dashboard Affiliate - EcoMarket">
    ...
    <!-- Custom CSS for Affiliate Dashboard -->
    <style>
        .affiliate-dashboard {
            padding: 60px 20px;
                ...
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-0">Selamat Datang, {{ $affiliate->name }}</h4>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Kode Affiliate Anda</h5>
                            <p class="card-text">
                                <span class="badge bg-primary fs-5">{{ $affiliate->affiliate_code }}</span>
                            </p>
                            <p class="card-text">
                                Gunakan kode di atas untuk mempromosikan produk kami dan dapatkan komisi!
                            </p>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <h6 class="card-title">Total Referral</h6>
                                ...
                                <div class="col-md-4 ```html
                                    <div class=" card text-center">
                                    <div class="card-body">
                                        <h6 class="card-title">Total Komisi</h6>
                            ...
                            <div class="col-md-4">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text fs-4">Rp 300.000</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <hr>
                    <a href="{{ route('affiliate.promotions') }}" class="btn btn-primary">Mulai Promosi</a>
                </div>
            </div>
        </div>
        </section>
