...
<div class="container-fluid">
    ...
    <p class="mb-4">Tambahkan produk yang diinginkan</p>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('produk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="idProduk" name="idProduk" value="{{ $nextProductId }}"
                        readonly>
                </div>
                ...
                <div class="form-group">
                    <img id="preview" src="#" alt="Preview Gambar" class="gmbrprd"
